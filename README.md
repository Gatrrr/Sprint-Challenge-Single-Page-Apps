...
The benefits is that you do not have to reload the page every time you click on something new. It is all stored on the app itself and makes it so no white flash appears. It makes it look alot smoother because of no white flash and less data gets proccessed so routing betewen views is faster.
